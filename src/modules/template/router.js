...
const { create, getTemplates, deleteTemplate, uploadTemplateMedia, checkLevelType, createFeedback, templateCount, getCreatorTemplate, templateOrder, update } = require("./controller");
const { validate } = require("../../middlewares/schema");
const { createContract, deleteContract, createFeedbackContract, setTemplateOrder, updateContract } = require("./contract");
...
templateRouter.post("/create-feedback", withAuthLearner, validate("body", createFeedbackContract), createFeedback);
...
templateRouter.patch("/template-order", withAdminAuthUser, validate("body", setTemplateOrder), templateOrder);
