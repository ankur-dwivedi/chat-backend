...
trackRouter.post("/createTrack", validate("body", createTrackContract), withAuthUser, trackController.post.createTrack);
trackRouter.post("/createTrackUsingLearnerId", validate("body", createTrackUsingLearnerIdContract), withAuthUser, trackController.post.createTrackUsingLearnerId);
trackRouter.post("/transferTrackOwner", validate("body", transferTrackOwnerContract), withAuthUser, trackController.post.transferTrackOwner);

trackRouter.put("/updateTrack/:trackId", validate("body", createTrackContract), withAuthUser, trackController.put.updateTrack);
trackRouter.put("/updateTrackUsingLearnerId/:trackId", validate("body", updateTrackUsingLearnerIdContract), withAuthUser, trackController.put.updateTrackUsingLearnerId);
